window.onload = function() {
    ...
    function showlist() {
        var newTodoDiv = document.getElementById('TodoList');
        newTodoDiv.innerHTML = "";
        Object.keys(list.listItems).forEach(function(temp)
        {
            if (list.listItems[temp].status == "ACTIVE") {
                var newItem = document.createElement("div");
                newItem.setAttribute("class", "StatusACTIVE Vertical Horizontal newItem");
                var complete_button = document.createElement("button");
                complete_button.setAttribute("class", "Horizontal  Vertical");
                ...
                edit_button.setAttribute("class","Horizontal Vertical Right" );
                ...
                delete_button.setAttribute("class", "Horizontal Vertical Right");
            ...
            if(list.listItems[temp].status == 'EDIT'){
                var newItem = document.createElement("div");
                newItem.setAttribute("class", "todoStatus Vertical Horizontal newItem");
                ...
                done_button.setAttribute("class", "Horizontal  Vertical");
                ...
                var delete_button = document.createElement("button");
                delete_button.setAttribute("class", "Horizontal Vertical floatRight");
                delete_button.innerText = "Delete";
                delete_button.onclick = function () {
                    deleteTodo(temp);
                    showlist();
            ...
            if(list.listItems[temp].status == 'COMPLETE'){
                ...
                newUndoCompleteItem.setAttribute("class", "StatusCOMPLETE Vertical Horizontal newItem");
                var undo_complete_button = document.createElement("button");
                undo_complete_button.setAttribute("class", "Horizontal  Vertical");
